...
DateStartPlay date DEFAULT CONVERT (date, GETDATE()));
GO
...
RateIDFK int NOT NULL CONSTRAINT TblRateFK FOREIGN KEY  REFERENCES Rates(RateIDPK));
GO
...
PlayerIDFK int CONSTRAINT MonARanFK FOREIGN KEY REFERENCES Players(PlayerIDPK),
